...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { country_id: @manufacturer.country_id, email: @manufacturer.email, manufacturer_name: @manufacturer.manufacturer_name } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { country_id: @manufacturer.country_id, email: @manufacturer.email, manufacturer_name: @manufacturer.manufacturer_name } }
